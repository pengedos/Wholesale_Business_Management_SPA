...
checkoutButton.addEventListener("click", () => {
  if (!cart.length) {
    showToast("Add at least one product before preparing a quote");
    return;
  }
  ...
  showToast("Quote request prepared. Contact sales@sikatarawtrading.com to complete the inquiry.");
  console.info("Wholesale quote request summary:", orderSummary);
});
